...
{
    /// <inheritdoc />
    public partial class AddRoomTypeImageTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomCharges = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    RestaurantCharges = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    LaundryCharges = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    OtherCharges = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    ...
                    RecordType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestBills_CheckInMasters_CheckInId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GuestBills_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuditStartTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AuditEndTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    OccupancyPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    ExtraRevenue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditLog", x => x.AuditId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompressedPath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditCharges", x => x.ChargeId);
                    table.ForeignKey(
                        name: "FK_NightAuditCharges_NightAuditLog_AuditId",
                        column: x => x.AuditId,
                        principalTable: "NightAuditLog",
                        principalColumn: "AuditId",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "NightAuditPayments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditPayments", x => x.PaymentId);
                    table.ForeignKey(
                        name: "FK_NightAuditPayments_NightAuditLog_AuditId",
                        column: x => x.AuditId,
                        principalTable: "NightAuditLog",
                        principalColumn: "AuditId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditRevenueSummary", x => x.SummaryId);
                    table.ForeignKey(
                        name: "FK_NightAuditRevenueSummary_NightAuditLog_AuditId",
                        column: x => x.AuditId,
                        principalTable: "NightAuditLog",
                        principalColumn: "AuditId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditRoomStatus", x => x.StatusId);
                    table.ForeignKey(
                        name: "FK_NightAuditRoomStatus_NightAuditLog_AuditId",
                        column: x => x.AuditId,
                        principalTable: "NightAuditLog",
                        principalColumn: "AuditId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuditId = table.Column<int>(type: "int", nullable: false),
                    BusinessDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VarianceType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NightAuditVariances", x => x.VarianceId);
                    table.ForeignKey(
                        name: "FK_NightAuditVariances_NightAuditLog_AuditId",
                        column: x => x.AuditId,
                        principalTable: "NightAuditLog",
                        principalColumn: "AuditId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestBills_ReservationId",
                table: "GuestBills",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_NightAuditCharges_AuditId",
                table: "NightAuditCharges",
                column: "AuditId");

            migrationBuilder.CreateIndex(
                name: "IX_NightAuditPayments_AuditId",
                table: "NightAuditPayments",
                column: "AuditId");

            migrationBuilder.CreateIndex(
                name: "IX_NightAuditRevenueSummary_AuditId",
                table: "NightAuditRevenueSummary",
                column: "AuditId");

            migrationBuilder.CreateIndex(
                name: "IX_NightAuditRoomStatus_AuditId",
                table: "NightAuditRoomStatus",
                column: "AuditId");

            migrationBuilder.CreateIndex(
                name: "IX_NightAuditVariances_AuditId",
