...
{
    /// <inheritdoc />
    public partial class AddComprehensiveAccountingModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("IF COL_LENGTH('RoomRates', 'ClosedToArrival') IS NULL ALTER TABLE [RoomRates] ADD [ClosedToArrival] bit NOT NULL CONSTRAINT [DF_RoomRates_ClosedToArrival] DEFAULT CAST(0 AS bit);");
            migrationBuilder.Sql("IF COL_LENGTH('RoomRates', 'ClosedToDeparture') IS NULL ALTER TABLE [RoomRates] ADD [ClosedToDeparture] bit NOT NULL CONSTRAINT [DF_RoomRates_ClosedToDeparture] DEFAULT CAST(0 AS bit);");
            migrationBuilder.Sql("IF COL_LENGTH('RoomRates', 'MaxStay') IS NULL ALTER TABLE [RoomRates] ADD [MaxStay] int NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('RoomRates', 'MinStay') IS NULL ALTER TABLE [RoomRates] ADD [MinStay] int NULL;");

            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToArrival') IS NULL ALTER TABLE [Plans] ADD [ClosedToArrival] bit NOT NULL CONSTRAINT [DF_Plans_ClosedToArrival] DEFAULT CAST(0 AS bit);");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToArrivalValidFrom') IS NULL ALTER TABLE [Plans] ADD [ClosedToArrivalValidFrom] datetime2 NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToArrivalValidTo') IS NULL ALTER TABLE [Plans] ADD [ClosedToArrivalValidTo] datetime2 NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToDeparture') IS NULL ALTER TABLE [Plans] ADD [ClosedToDeparture] bit NOT NULL CONSTRAINT [DF_Plans_ClosedToDeparture] DEFAULT CAST(0 AS bit);");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToDepartureValidFrom') IS NULL ALTER TABLE [Plans] ADD [ClosedToDepartureValidFrom] datetime2 NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ClosedToDepartureValidTo') IS NULL ALTER TABLE [Plans] ADD [ClosedToDepartureValidTo] datetime2 NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'PriceAdjustmentType') IS NULL ALTER TABLE [Plans] ADD [PriceAdjustmentType] nvarchar(30) NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'PriceDifferenceType') IS NULL ALTER TABLE [Plans] ADD [PriceDifferenceType] nvarchar(30) NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'PriceDifferenceValue') IS NULL ALTER TABLE [Plans] ADD [PriceDifferenceValue] decimal(18,2) NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'StopSell') IS NULL ALTER TABLE [Plans] ADD [StopSell] bit NOT NULL CONSTRAINT [DF_Plans_StopSell] DEFAULT CAST(0 AS bit);");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ValidFrom') IS NULL ALTER TABLE [Plans] ADD [ValidFrom] datetime2 NULL;");
            migrationBuilder.Sql("IF COL_LENGTH('Plans', 'ValidTo') IS NULL ALTER TABLE [Plans] ADD [ValidTo] datetime2 NULL;");
