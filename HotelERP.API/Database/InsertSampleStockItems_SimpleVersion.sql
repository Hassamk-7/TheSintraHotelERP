-- Simple version - Just the INSERT statements
-- Copy and paste into SSMS and execute

SET IDENTITY_INSERT [dbo].[ItemMasters] ON;

INSERT INTO [dbo].[ItemMasters] (Id, Name, Code, Description, Category, Unit, PurchasePrice, SalePrice, MinStockLevel, MaxStockLevel, CurrentStock, Supplier, Brand, IsPerishable, ExpiryDate, StorageLocation, IsActive, CreatedAt, UpdatedAt)
VALUES
...
-- Verify
SELECT COUNT(*) as TotalInserted FROM [dbo].[ItemMasters] WHERE Id BETWEEN 1 AND 15;
